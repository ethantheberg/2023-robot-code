...
class SetPickAndPlacePosition(val continuous: Boolean ,val subsystem: PickAndPlaceSubsystem,
    ...
    override fun execute() {
        ...
        elevatorPid.i = ArmConstants.elevatorI;
        elevatorPid.d = ArmConstants.elevatorD;
        elbowPid.p = ArmConstants.elbowP;
        elbowPid.i = ArmConstants.elbowI;
        elbowPid.d = ArmConstants.elbowD;
        wristPid.p = ArmConstants.wristP;
        wristPid.i = ArmConstants.wristI;
        wristPid.d = ArmConstants.wristD;
...
class runMotors(val elevatorVoltage: Double,
                val elbowVoltage: Double,
                val wristVoltage: Double,
                val intakeVoltage: Double,
                val subsystem: PickAndPlaceSubsystem)
    : CommandBase() {
    ...
    override fun execute() {
        subsystem.elevatorVoltage = elevatorVoltage
        subsystem.elbowVoltage = elbowVoltage
        subsystem.wristVoltage = wristVoltage
        subsystem.intakesVoltage = intakeVoltage
    }
